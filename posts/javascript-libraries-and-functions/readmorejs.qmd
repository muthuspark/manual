---
title: "Readmore.js - A Developer's Handbook"
...
**2. CDN:** Include the library using a CDN link in your HTML file.  (Note:  Replace with the actual CDN link if one is available for the library).
