---
title: "libphonenumber - A Developer's Handbook"
...
1.  Install vcpkg following the instructions on the [vcpkg website](https://vcpkg.io/).
...
1.  Clone the libphonenumber repository from [GitHub](<Replace with GitHub Repo URL>).
