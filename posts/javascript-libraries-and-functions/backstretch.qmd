---
title: "Backstretch - A Developer's Handbook"
categories: [ "JavaScript Libraries and Functions" ]
---
## Introduction to Backstretch.js
...
```html
<script src="path/to/jquery.min.js"></script>  <!-- Replace with your jQuery path -->
<script src="path/to/jquery.backstretch.min.js"></script> <!-- Replace with your Backstretch.js path -->
```
