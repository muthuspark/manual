---
title: "prettyPhoto - A Developer's Handbook"
...
The latest version of prettyPhoto can be downloaded from [insert download link here - replace with actual link].  The download typically includes the following files:
