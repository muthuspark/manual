---
title: "carouFredSel - A Developer's Handbook"
...
To use carouFredSel, you'll need to include the jQuery library and the carouFredSel plugin in your HTML file.  You can download the plugin from [link to download - replace with actual link].

1. **Include jQuery:** Add the jQuery library to your project.  You can either download it from the jQuery website ([link to jQuery - replace with actual link]) or use a CDN, such as:
...
2. **Include carouFredSel:** After including jQuery, add the carouFredSel plugin file to your project:
   ...
   ```html
   <script src="path/to/jquery.carouFredSel.js"></script>  <!-- Replace with the actual path -->
   ```
