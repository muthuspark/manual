...
description: "xlrd is a pure Python library for reading data from Microsoft Excel (®) spreadsheet files (.xls). It supports both older .xls files (using the BIFF 8-12..."
date: "2025-02-09"
